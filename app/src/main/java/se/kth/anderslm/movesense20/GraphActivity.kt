...
class GraphActivity : AppCompatActivity(), Serializable {
    private val time: DataPoint? = null
    private val elevation: DataPoint? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DeserializeFromFile(time, elevation).readFromFile(this.filesDir)
    }
}